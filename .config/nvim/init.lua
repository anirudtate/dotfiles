...
-- [[ Format on save ]]
local format_group = vim.api.nvim_create_augroup('FormatSave', { clear = true })
...
vim.keymap.set('n', '<leader>cc',
  ":w<cr>:!g++ -std=c++17 -Wshadow -Wall -g -fsanitize=address -fsanitize=undefined -D_GLIBCXX_DEBUG -DLOCAL %<cr>")
vim.keymap.set('n', '<leader>rr', ":vsp term://./a.out<cr>i")
